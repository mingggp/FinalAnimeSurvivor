...
import entityInterface.itemInterface.Material;
import javafx.geometry.BoundingBox;
import javafx.scene.canvas.GraphicsContext;
import javafx.scene.image.Image;

public class SukunaFinger extends Item implements Material, Droppable {

    private GameManager gameManager;
    private BoundingBox itemHitBox;

    public SukunaFinger(GameManager gameManager){
        super("sukunaFinger");
        this.setAmount(1);
    ...
    public SukunaFinger(SukunaFinger sukunaFinger){
        ...
        this.setAmount(1);
        this.gameManager = sukunaFinger.gameManager;
        this.setIcon(sukunaFinger.getIcon());
    }
    @Override
    public GameObject copy() {
        return new SukunaFinger(this);
    }
